...
public class PaystationUI extends JFrame implements IPaystationUI {
	...
	public PaystationUI(int x, int y) {
		...
		panel_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Ticket Reader",
		...
		panel_2.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Paystation Ticket Printer",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
